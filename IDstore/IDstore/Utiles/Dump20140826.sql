...
CREATE TABLE `registroes` (
  `idregistro` varchar(200) NOT NULL,
  `dni` char(8) DEFAULT NULL,
...
CREATE TABLE `tanquedetallemov` (
  ...
  `idregistro` varchar(200) DEFAULT NULL,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_Busqueda_Captura_X_Codigo_Abastecimiento` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Busqueda_Captura_X_Codigo_Abastecimiento`(in codigo_abastecimiento varchar(200))
BEGIN
select c.dni, c.nombres, c.apellidos, t.codigo_abastecimiento, t.snapshotpicture, t.snapshotvideo,t.volumen_retirado,a.idtanque  from id_store_db.colaboradores as c
inner join id_store_db.registroes as r on r.dni=c.dni
inner join id_store_db.tanquedetallemov as t on t.idregistro=r.idregistro
inner join id_store_db.abastecimiento as a on a.codigo_abastecimiento=t.codigo_abastecimiento
where t.codigo_abastecimiento=codigo_abastecimiento ;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_Busqueda_Captura_X_DNI` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Busqueda_Captura_X_DNI`(in dni char(8))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_Busqueda_Captura_X_NombresyApellidos` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Busqueda_Captura_X_NombresyApellidos`(in nombres varchar(200),in apellidos varchar(200))
BEGIN
select c.dni, c.nombres, c.apellidos, t.codigo_abastecimiento, t.snapshotpicture, t.snapshotvideo,t.volumen_retirado,a.idtanque  from id_store_db.colaboradores as c
inner join id_store_db.registroes as r on r.dni=c.dni
inner join id_store_db.tanquedetallemov as t on t.idregistro=r.idregistro
inner join id_store_db.abastecimiento as a on a.codigo_abastecimiento=t.codigo_abastecimiento
where c.nombres like nombres or c.apellidos like apellidos;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_Busqueda_Captura_X_Nro_Tanque` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Busqueda_Captura_X_Nro_Tanque`(in Nro_Tanque char(3) )
BEGIN
select c.dni, c.nombres, c.apellidos, t.codigo_abastecimiento, t.snapshotpicture, t.snapshotvideo,t.volumen_retirado,a.idtanque  from id_store_db.colaboradores as c
inner join id_store_db.registroes as r on r.dni=c.dni
inner join id_store_db.tanquedetallemov as t on t.idregistro=r.idregistro
inner join id_store_db.abastecimiento as a on a.codigo_abastecimiento=t.codigo_abastecimiento
where t.idtanque=Nro_Tanque;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Nuevo_Registro_ES`(in idregistro varchar(200), in dni  char(8),
...
in idtanque char(10),
in idregistro varchar(200),
in codigo_abastecimiento char(22),
in volumen_retirado double ,
in snapshotpicture Longblob,
in snapshotvideo varchar(800),
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_UltimoRegistro_X_Year_dni` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_UltimoRegistro_X_Year_dni`(in cadena varchar(200) )
BEGIN
SELECT * FROM id_store_db.registroes WHERE idregistro LIKE  cadena ORDER BY idregistro desc limit 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2014-08-26 20:44:42
